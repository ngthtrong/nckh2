...
**Độ nhạy (Thí nghiệm 2).** ARI ổn định 0,892 với $\lambda\le1{,}5$; $\sigma_{geo}$ điều khiển đánh đổi đường kính/số cụm (0,28 km ở 200 m → 1,59 km ở 4000 m); $s=10$ cho vùng phân biệt $\mathcal{V}_{agg}$ tốt tới $\sum V_i\approx50$.
...
**Độ ổn định xếp hạng (Thí nghiệm 5).** Nhiễu loạn $\omega$ quanh mặc định (200 thử nghiệm/mức), đo Kendall's τ của thứ hạng $\mathcal{P}(C_k)$: τ trung bình **0,994** ở ±0,05, **0,986** ở ±0,10, và 0,957 ở ±0,20; tập 3 cụm ưu tiên cao nhất giữ nguyên 99–100% ở dao động thực tế — xếp hạng ổn định, không tùy tiện theo $\omega$.
